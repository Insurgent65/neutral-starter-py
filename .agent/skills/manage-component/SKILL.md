...
- **IMPORTANT**: Prepare the component so that it can be translated, but do not translate the component unless the user explicitly requests it.
...
- **IMPORTANT**: All text should be in BIF `{:trans; Text :}` for future translation.
